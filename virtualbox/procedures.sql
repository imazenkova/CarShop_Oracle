...
-----------------------------------????????????????
--superkey12345678 - ключ шифровани€ (также RAW). ƒлина ключа должна соответствовать вы≠бранному алгоритму. Ќапример, дл€ алгоритма DES она должна быть не менее 64 биn
...
--—сылка на курсор дает возможность не заводить структуры курсора (CURSOR Е IS Е) в клиентской программе, а ограничитьс€ в ней выделением пам€ти только дл€ адреса курсора,
